...
namespace GenesysLite\GenesysFact\Requests\Inputs;

use GenesysLite\GenesysBusiness\Models\Configuration;
use GenesysLite\GenesysFact\Models\OfflineConfiguration;
use GenesysLite\GenesysFact\Requests\Inputs\Common\ActionInput;
use GenesysLite\GenesysFact\Requests\Inputs\Common\EstablishmentInput;
use GenesysLite\GenesysFact\Requests\Inputs\Common\LegendInput;
use GenesysLite\GenesysFact\Requests\Inputs\Common\PersonInput;
use GenesysLite\GenesysInventory\Models\Item;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Str;
use GenesysLite\GenesysFact\Requests\Inputs\Transform\DocumentWebTransform;
...
class DocumentInput
{
    ...
    public static function set($inputs)
    {
        ...
        $soap_type_id = Configuration::soapType()->value;
