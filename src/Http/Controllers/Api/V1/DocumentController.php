<?php
namespace GenesysLite\GenesysFact\Http\Controllers\Api\V1;

use Exception;
use GenesysLite\GenesysCatalog\Models\StateType;
use GenesysLite\GenesysFact\Facturalo;
use GenesysLite\GenesysFact\Http\Controllers\Controller;
use GenesysLite\GenesysFact\Http\Controllers\DocumentController as DocumentControllerSend;
use GenesysLite\GenesysFact\Helpers\Storage\StorageDocument;
use GenesysLite\GenesysFact\Http\Resource\DocumentCollection;
