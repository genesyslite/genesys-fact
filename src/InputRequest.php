...
class InputRequest
{
    ...
    {
        $class = "GenesysLite\\GenesysFact\\Requests\\Api\\Transform\\".ucfirst($type)."Transform";
        return $class::transform($inputs);
    }

    private function validationInputs($inputs, $type, $service)
    {
        $class = "GenesysLite\\GenesysFact\\Requests\\".ucfirst($service)."\\Validation\\".ucfirst($type)."Validation";
        return $class::validation($inputs);
    }

    private function setInputs($inputs, $type, $service)
    {
        $class = "GenesysLite\\GenesysFact\\Requests\\Inputs\\".ucfirst($type)."Input";
