...
namespace GenesysLite\GenesysFact;

use GenesysLite\GenesysBusiness\Models\Configuration;
use GenesysLite\GenesysFact\Helpers\QrCode\QrCodeGenerate;
use GenesysLite\GenesysFact\Helpers\Xml\XmlFormat;
use GenesysLite\GenesysFact\Helpers\Xml\XmlHash;
use GenesysLite\GenesysFact\Helpers\Storage\StorageDocument;
use GenesysLite\GenesysFact\Models\Dispatch;
use GenesysLite\GenesysFact\Models\Document;
use GenesysLite\GenesysFact\Models\Perception;
use GenesysLite\GenesysFact\Models\Retention;
use GenesysLite\GenesysFact\Models\Summary;
use GenesysLite\GenesysFact\Models\Voided;
use GenesysLite\GenesysFact\WS\Client\WsClient;
use GenesysLite\GenesysFact\WS\Services\BillSender;
use GenesysLite\GenesysFact\WS\Services\ConsultCdrService;
use GenesysLite\GenesysFact\WS\Services\ExtService;
use GenesysLite\GenesysFact\WS\Services\SummarySender;
use GenesysLite\GenesysFact\WS\Services\SunatEndpoints;
use GenesysLite\GenesysFact\WS\Signed\XmlSigned;
use GenesysLite\GenesysFact\WS\Validator\XmlErrorCodeProvider;
...
class Facturalo
{
    ...
    {
        $this->configuration = Configuration::BusinessData();
        $this->company = Configuration::BusinessData();
    ...
    public function createPdf($document = null, $type = null, $format = null)
    {
        ...
        $path_css = __DIR__ . DIRECTORY_SEPARATOR . 'Templates' .
            DIRECTORY_SEPARATOR . 'pdf' .
            DIRECTORY_SEPARATOR . $base_pdf_template .
...
//            $message = 'La SUNAT no responde a su solicitud, vuelva a intentarlo.';
    ...
    private function setPathCertificate()
    {
        if ($this->isOse) {
            ...
            if ($this->isDemo) {
                $this->pathCertificate = __DIR__ . DIRECTORY_SEPARATOR . 'WS' . DIRECTORY_SEPARATOR . 'Signed' . DIRECTORY_SEPARATOR .
